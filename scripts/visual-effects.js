...
(function exposeVisualEffects(global) {
  ...
  class VisualEffectsSystem {
    ...
    drawClassPortrait(ctx,cls,x,y,w,h){const visual=CLASS_ART_ALIAS[cls]||cls;return this.drawProductionRegion(ctx,`class-${visual}`,x,y,w,h);}
